...
import { CheckOutCase, ResolveCase, GetAllCases, GetAllUsers, VerifyUser, SuspendUser, GetCaseStatistics, GetUserStatistics, Search, GetCasesByUser, GetTopCommunities, GetTopWards, GetTopLGAs, GetCasesByLocation, MakeUserAdmin, GetMonthlyStatistics } from "../controllers/admin.controller.js";
...
router.route('/users/:userID/make-admin').post(authMiddleware, adminMiddleware, MakeUserAdmin);
...
router.route('/analytics/monthly').post(authMiddleware, adminMiddleware, GetMonthlyStatistics);
